...
const ingredients: Ingredient[] = [
  {
    ...
    name: "Иван-чай",
    description:
      "Традиционный русский травяной чай с мягким вкусом и множеством полезных свойств. Собран вручную в экологически чистых районах Карелии.",
    image: "https://i.imgur.com/CnL7W7D.jpg",
  ...
  },
  {
    ...
    name: "Черника",
    description:
      "Ягоды и листья черники, собранные в карельских лесах. Придают чаю легкий ягодный аромат и приятную кислинку.",
    image: "https://i.imgur.com/3k1OkrC.jpg",
  ...
  },
  {
    ...
    name: "Мята",
    description:
      "Свежая мята, добавляющая освежающие нотки и приятное послевкусие. Выращена в экологически чистых условиях.",
    image: "https://i.imgur.com/O2vCi4G.jpg",
    benefits: [
  ...
  },
  {
    ...
    name: "Чабрец",
    description:
      "Душистый чабрец карельского происхождения. Добавляет чаю пряный аромат и терпкость.",
    image: "https://i.imgur.com/VJRkO2j.jpg",
  ...
  },
  {
    ...
    name: "Зверобой",
    description:
      "Солнечный зверобой, собранный на карельских лугах. Придает чаю легкую горчинку и целебные свойства.",
    image: "https://i.imgur.com/4B7FhL2.jpg",
    benefits: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-tapiola-brown max-w-2xl mx-auto">
            Мы тщательно отбираем и собираем карельские травы, сохраняя их
            целебные свойства. Каждый ингредиент вносит свой вклад в
            неповторимый вкус и аромат чая Тапиола.
          </p>
        </div>
                  ...
                  <ul className="space-y-2">
                    {activeIngredient.benefits.map((benefit, index) => (
                      <li key={index} className="flex items-start">
                        <Icon
                          name="Check"
                          className="text-tapiola-green-dark mr-2 mt-0.5 flex-shrink-0"
                          size={18}
                        />
